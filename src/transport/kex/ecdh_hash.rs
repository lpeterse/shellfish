...
mod test {
    ...
    fn test_kex_hash_01() {
        ...
        let server_host_key = PublicKey::Ed25519PublicKey(SshEd25519PublicKey([106,114,105,46,246,21,248,172,243,187,200,45,247,246,225,218,206,250,145,15,246,140,131,40,234,255,135,177,8,161,128,79]));
        let dh_client_key = x25519_dalek::PublicKey::from([163,184,73,53,101,235,117,249,31,97,178,63,135,35,65,5,189,180,255,250,242,232,76,164,186,212,21,0,223,144,162,77]);
        let dh_server_key = x25519_dalek::PublicKey::from([236,229,149,54,50,179,149,65,53,52,47,205,191,6,241,2,134,85,228,18,66,201,189,121,8,17,122,81,175,192,25,58]);

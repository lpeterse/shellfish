...
impl ChannelList {
    ...
    pub fn get_open(&mut self, id: u32) -> Result<&mut ChannelState, ConnectionError> {
    ...
    pub fn accept(&mut self, id: u32, channel: ChannelState) -> Result<(), ConnectionError> {

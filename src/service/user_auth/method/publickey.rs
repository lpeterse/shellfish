...
mod tests {
    ...
    #[test]
    fn test_debug_01() {
        let pk = Identity::PublicKey(PublicKey::Ed25519(SshEd25519PublicKey([2; 32])));
        let sg = Signature::Ed25519(SshEd25519Signature([3; 64]));
        let x: PublicKeyMethod = PublicKeyMethod {
            identity: pk,
            signature: Some(sg),
        };
        assert_eq!(format!("{:?}", x), "PublicKeyMethod { identity: PublicKey(Ed25519(SshEd25519PublicKey([2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]))), signature: Some(Ed25519(SshEd25519Signature([3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]))) }");
    }
    ...
    fn test_decode_01() {
        let identity = Identity::PublicKey(PublicKey::Ed25519(SshEd25519PublicKey([2; 32])));
        let x: PublicKeyMethod = BDecoder::decode(
            &[

...
// use shellfish::connection::Global;
// use shellfish::connection::GlobalRequest;
// use shellfish::connection::GlobalRequestWantReply;
// use shellfish::connection::GlobalWantReply;
